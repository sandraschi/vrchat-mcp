...
4. Start the server:
   ...
   uv run uvicorn vrchat_mcp.server:app --port 10712
   ```
5. Open `http://localhost:10712` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/vrchat-mcp/issues) |
