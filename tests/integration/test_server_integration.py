...
class TestServerIntegration:
    ...
    async def test_server_startup_fastapi(self):
        ...
        try:
            ...
            response = requests.get("http://127.0.0.1:8999/api/docs")
            assert response.status_code == 200

            # Test OpenAPI schema
            response = requests.get("http://127.0.0.1:8999/api/v1/openapi.json")
            assert response.status_code == 200
    ...
    async def test_server_graceful_shutdown(self):
        ...
        try:
            ...
            response = requests.get("http://127.0.0.1:9003/health")
            assert response.status_code == 200
