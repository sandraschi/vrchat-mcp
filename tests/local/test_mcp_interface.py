...
class MCPTester:
    ...
    async def test_tools_list(self) -> bool:
        ...
        try:
            ...
            required_tools = [
                "get_server_status", "get_health_status", "get_help",
                "get_avatar_state", "load_avatar", "set_parameter", "get_parameter",
                "send_osc_message", "get_osc_statistics"
            ]
            ...
            try:
                ...
                if topic == "invalid_topic":
                    if "error" not in result:
                        logger.error(f"get_help should return error for invalid topic")
                        return False
                else:
