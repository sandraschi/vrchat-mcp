...
class SystemPlugin(Plugin):
    ...
    @tool(
        ...
        examples=[
            {"description": "Get system info", "code": "system_info()"}
        ]
    )
    ...
    async def shutdown_server(self, restart: bool = False, delay: int = 0) -> Dict[str, Any]:
        ...
        if restart:
            ...
            if hasattr(self.mcp, 'stop'):
                asyncio.create_task(self.mcp.stop())
    ...
    @tool(
        ...
        category="System",
        args={
            "include_tools": {"type": "boolean", "description": "Whether to include tool details", "default": False}
        },
