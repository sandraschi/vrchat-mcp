...
from scripts.audit_plugins import PluginAudit, PLUGINS_DIR

def generate_report(report: Dict[str, Any], output_file: Optional[str] = None) -> str:
    ...
    if report['tools']:
        ...
        for tool in report['tools']:
            ...
            missing_meta = [m for m in ['description', 'category', 'args', 'returns'] 
                          if m not in tool or not tool[m]]
            if missing_meta:
