...
Examples:
  ...
  vrchat-mcp
    ...
    parser.add_argument("--log-file", type=str, help="Path to log file (logs to console if not specified)")

    # OSC Configuration
    osc_group = parser.add_argument_group("OSC Configuration")
    osc_group.add_argument("--osc-client-ip", default="127.0.0.1", help="OSC client IP address (default: 127.0.0.1)")
    osc_group.add_argument("--osc-client-port", type=int, default=9000, help="OSC client port (default: 9000)")
    osc_group.add_argument("--osc-server-ip", default="127.0.0.1", help="OSC server IP address (default: 127.0.0.1)")
    osc_group.add_argument("--osc-server-port", type=int, default=9001, help="OSC server port (default: 9001)")

    # Debug UI Configuration
    debug_group = parser.add_argument_group("Debug UI Configuration")
    debug_group.add_argument("--debug-ui", action="store_true", default=True, help="Enable debug UI (default: enabled)")
    debug_group.add_argument("--no-debug-ui", action="store_false", dest="debug_ui", help="Disable debug UI")
    debug_group.add_argument("--debug-ui-host", default="127.0.0.1", help="Debug UI host (default: 127.0.0.1)")
    debug_group.add_argument("--debug-ui-port", type=int, default=8765, help="Debug UI port (default: 8765)")
