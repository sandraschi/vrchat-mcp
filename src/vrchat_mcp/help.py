...
class HelpEntry:
    ...
    def __init__(
        ...
        notes: Optional[Dict[HelpLevel, str]] = None,
...
class HelpSystem:
    ...
    parameters={
        ...
        'MyBoolParameter': True
            ...
            notes={
                ...
                HelpLevel.ADVANCED: "The avatar change is not guaranteed to be immediate. Listen for the 'avatar_changed' event for confirmation.",
        ...
        self.add_entry(HelpEntry(
            ...
            notes={
                ...
                HelpLevel.INTERMEDIATE: "Different easing functions can create different visual effects. Try 'ease_in_out_quad' for subtle movements or 'bounce_out' for playful bounces.",
                HelpLevel.ADVANCED: "Interpolation runs in a background task at ~60fps. Use stop_parameter_interpolation() to cancel an in-progress transition.",
                HelpLevel.DEVELOPER: "Uses a dedicated InterpolationManager with support for multiple easing functions. Each parameter is interpolated independently with its own timing."
            },
    ...
    def get_help(
        ...
        level: Union[HelpLevel, str] = HelpLevel.INTERMEDIATE,
    ...
    def _list_topics(self, level: HelpLevel, category: Optional[HelpCategory] = None) -> str:
