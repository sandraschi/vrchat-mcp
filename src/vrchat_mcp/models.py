...
class ParameterValue:
    ...
    def __init__(self, value: Any, value_type: str | None = None, timestamp: float | None = None):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {"value": self.value, "type": self.value_type, "timestamp": self.timestamp}

    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "ParameterValue":
        """Create from a dictionary."""
        return cls(value=data.get("value"), value_type=data.get("type"), timestamp=data.get("timestamp"))
...
class AvatarLoadRequest:
    ...
    timeout: float | None = None  # Seconds to wait for avatar to load
...
class AvatarParameterRequest:
    ...
    parameter_type: AvatarParameterType | None = None
...
class NPCConversationRequest:
    ...
    timeout: float | None = None  # Seconds before the conversation times out
...
class ConnectionStats:
    ...
    last_message_sent: float | None = None
    last_message_received: float | None = None
    errors: int = 0
